                ...
                <tr key={i} className="hover:bg-white/5 transition-colors">
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <div className="text-[10px] text-neutral-600 mt-1 font-mono">
                      Up: {Math.floor(r.uptime_seconds / 60)}m
                    </div>
                  </td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex items-center gap-2 text-sm text-neutral-300">
                        ...
                        <span>{r.humidity?.toFixed(0)}%</span>
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center gap-2.5">
                      <div className={`p-1.5 rounded-full bg-white/5 ${r.sound_level > 50 ? 'animate-pulse' : ''}`}>
                        <Mic className={`w-4 h-4 ${r.sound_level > 50 ? 'text-purple-400' : 'text-neutral-500'}`} />
                      </div>
                      <div className="flex flex-col">
                        <span className="text-sm text-neutral-300">
                          {r.sound_level?.toFixed(1)} dB
                        </span>
                      </div>
                    </div>
                  </td>
